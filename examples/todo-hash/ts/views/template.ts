...
// Director router type
interface RouterInterface {
    on(route: string | RegExp, handler: (path?: string) => void): void;
    getRoute(): string[];
...
export class TodoTemplate {
    static inject = ['scope', 'template', 'model', 'router'];

    constructor(scope: TodoScope, template: SomaTemplate, model: ModelInterface, router: RouterInterface) {
